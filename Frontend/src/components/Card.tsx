...
const Card: React.FC<CardProps> = ({ transaction, authUser, cardType }) => {
  let { category, amount, location, date, paymentType, description } = transaction || {};

  // const cardClass = categoryColorMap ?? [category];
  const cardClass = cardType ? categoryColorMap[cardType] : categoryColorMap;
  console.log('colorMap', cardClass, category);
